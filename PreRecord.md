...
<div style='display:none' id='myDiv'>В справочнике "Кабинеты" выберите нужный кабинет и поставьте отметку о блокировании паралельной предзаписи<img src="Image/block.png"> </div>
